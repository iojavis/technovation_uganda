							...
							<div className='mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center'>
								<div className='relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl'>
									...
									<p className='mt-6 text-lg leading-8 text-gray-600 sm:max-w-md lg:max-w-none'>
										Every year, girls across the globe step up to
										solve problems in their community with technology
										through Technovation Girls. Supported by a network
										of mentors, ambassadors, volunteers and parents,
										these girls are changing the world—join them.
									</p>
